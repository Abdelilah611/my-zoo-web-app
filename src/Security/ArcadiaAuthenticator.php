...
class ArcadiaAuthenticator extends AbstractLoginFormAuthenticator
{
    use TargetPathTrait;
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        // Ensure $email is a string to prevent type juggling
        $email = (string) $email;
        ...
        // Ensure csrfToken is a string or null
